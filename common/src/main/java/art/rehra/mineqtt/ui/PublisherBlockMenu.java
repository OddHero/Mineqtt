...
public class PublisherBlockMenu extends AbstractContainerMenu {
    ...
    public PublisherBlockMenu(int containerId, Inventory playerInventory, Player player, BlockPos blockPos) {
        this(containerId, playerInventory, (Container) playerInventory.player.level().getBlockEntity(blockPos), player, blockPos);
    }

    public PublisherBlockMenu(int containerId, Inventory playerInventory, Container container, Player player, BlockPos blockPos) {
        super(MineqttMenuTypes.PUBLISHER_BLOCK_MENU.get(), containerId);
