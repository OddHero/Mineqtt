...
public class RgbLedBlockMenu extends AbstractContainerMenu {
    public Container container;
    public final Player player;
    public BlockPos blockPos;

    public RgbLedBlockMenu(int containerId, Inventory playerInventory, Player player, BlockPos blockPos) {
        this(containerId, playerInventory, (Container) playerInventory.player.level().getBlockEntity(blockPos), player, blockPos);
    }

    public RgbLedBlockMenu(int containerId, Inventory playerInventory, Container container, Player player, BlockPos blockPos) {
        super(MineqttMenuTypes.RGB_LED_BLOCK_MENU.get(), containerId);
